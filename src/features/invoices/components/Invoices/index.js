...
import { Tabs, MainLayout,CtGradientButton,DefaultLayout } from '../../../../components';
...
export class Invoices extends React.Component<IProps> {
    ...
    onAddInvoice = () => {
      let total_invoices=parseInt(this.props.invoices.length);
        if(total_invoices>3){
              //    Alert.alert(total_invoices+'buy our plan') 
        ...
        return (
            ...
            {this.state.isSubscription && 
                ...
                >
                    ...
                    <Text style={{fontWeight: 'bold',color:'red',margin:10,textAlign:'center',fontSize:20}} >
                                            To add more then three invoices please buy our primium plan
                                        </Text>          
                   <CtGradientButton
                                         btnTitle='Buy our premium plan'
                                        loading={loading}
